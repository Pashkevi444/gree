...
final class CatalogControllerTest extends TestCase
{
    public function testConstructorAcceptsCatalogService(): void
    {
        ...
        $seo = $this->createMock(\Gree\Contract\Service\SeoServiceInterface::class);
        $controller = new CatalogController($service, $crumbs, $seo);
    ...
    public function testBuildItemPayloadBestseller(): void
    {
        ...
        // Path is generated by Route::to('catalog.product', …). Stub returns
        // "/catalog.product/?section=nastennie&code=gree-bora-x" — assert both
        // params plumbed through, don't pin the exact format.
        $this->assertStringContainsString('catalog.product', $payload['href']);
        $this->assertStringContainsString('section=nastennie', $payload['href']);
        $this->assertStringContainsString('code=gree-bora-x', $payload['href']);
    }
